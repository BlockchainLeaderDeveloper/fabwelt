    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automatically claim SPYRIT on your behalf!
        </TYPE.main>
          ...
          <DataRow style={{ marginBottom: '1rem' }}>
            { !stakingInfo?.ended &&
              <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
                  {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? 'Deposit' : stakingInfo && stakingInfo?.name !== '' ? 'Deposit ' + stakingInfo?.name + " Tokens" : 'Deposit SPYRIT Token'}
              </ButtonPrimary>
            }
